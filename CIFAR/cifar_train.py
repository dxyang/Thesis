    ...
    for i in range(n_iterations):
      ...
      if i%100 == 0:
        if (i < switch):
          ...
          train_total_cost, train_l2, train_g_loss, train_d_loss, disc_fake, disc_real = sess.run([net.total_cost, net.cost, net.g_loss, net.d_loss, net.avg_disc_fake, net.avg_disc_real], feed_dict={net.x: batch_in,
                                                     net.y: batch_out, 
                                                     net.keep_prob: 1.0})
          print("step %d, total %g, l2 %g, gen %g, disc %g" %(i, train_total_cost, train_l2, train_g_loss, train_d_loss))
