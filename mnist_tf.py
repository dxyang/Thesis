...
def create_network(learning_rate=1e-5):
  class Net:
    # layer 0
    ...
    dim1 = 16
    dimTotal = dim1 * dim1 * 32
    h_conv_flat = tf.reshape(h_conv6, [-1, dimTotal])
    ...
    #mse = tf.reduce_mean(tf.nn.sigmoid_cross_entropy_with_logits(y_conv, y_))
